...
|-------|--------|-------|------------|
| `scarlet_vale_sheet, _2-7.png` | scarlet_vale | heroes | scarlet_vale |
| `balthazar_sheet, _2-7.png` | balthazar | heroes | balthazar |
| `jester_sheet, _2.png` | jester | enemies | jester |
...
| `projectile_sheet.png` | projectile_1 | projectiles | projectile_1 |
...
| `doodle_dink_sheet.png` | doodle_dink | enemies | doodle_dink_1 | Striped jester attacks — 3×5 grid (teleport, tomato throw, headbutt) |
...
1. `ratchet_rumbelow_sheet.png` → `boss/ratchet_rumbelow_`
...
14. `doodle_dink_sheet.png` → `enemies/doodle_dink_`
