...
<style>
  html,body{margin:0;height:100%;background:#05070f;color:#cfe4ff;font-family:'Courier New',monospace;}
  #wrap{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:26px;}
