...
Verification: open petal-panic/index.html
...
Files: + petal-panic/js/entity.js
...
Verification: node -e "require('./petal-panic/js/entity.js')" 2>/dev/null || echo browser-only
...
Verification: grep -n 'L\.' petal-panic/js/collision.js
...
Files: + petal-panic/js/projectile.js
...
Files: ~ petal-panic/js/hero.js
Files: + petal-panic/js/damage.js
...
Files: + petal-panic/js/jester.js
...
Files: + petal-panic/js/object.js
...
Files: + petal-panic/js/powerup.js
Files: ~ petal-panic/js/state.js
...
Files: + petal-panic/js/vine_hound.js
Files: + petal-panic/js/violetta.js
Files: + petal-panic/js/jackolantern.js
Files: + petal-panic/js/boris_loon.js
